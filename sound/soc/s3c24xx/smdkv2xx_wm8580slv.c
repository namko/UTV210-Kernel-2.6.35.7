...
#define DEBUG_WM8580
#ifdef DEBUG_WM8580
#define WM8580_DEBUG(format, arg...) printk(/*KERN_DEBUG*/"[audio_wm wm8580]: " format, ## arg)
#else
#define WM8580_DEBUG(format, arg...) do{ } while(0)
#endif
...
static int set_epll_rate(unsigned long rate)
{
	...
	WM8580_DEBUG("Entered %s, rate=%ld, wait = %d\n", __func__, rate, wait_utime);
