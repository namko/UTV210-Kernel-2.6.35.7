...
static unsigned int stop_bus_clock = 0; /* atheros stop-bus-clk */
...
int sdhci_add_host(struct sdhci_host *host)
{
	...
	mmc->caps |= MMC_CAP_ATHEROS_WIFI; //wangkai for wifi
	mmc->ocr_avail = 0;
...
module_param(stop_bus_clock, uint, 0444); /* atheros stop-bus-clk */
