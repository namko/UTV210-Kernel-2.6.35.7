...
#define FIMC_CROP_FUNC   //lfj 110215,for fimc crop function 

//lfj 110221,for preview and snapshot size settings
//#define FIMC_SET_SNAPSHOT_SIZE 
//snapshot size, customer could modify these by their needs 
#define QXGA_WIDTH 2048  //snapshot size 1
#define UXGA_WIDTH 1600  //snapshot size 2
#define SXGA_WIDTH 1280  //snapshot size 3

#define VGA_WIDTH   640   //preview size 
#define DEFAULT_SENSOR_WIDTH 640  
#define DEFAULT_SENSOR_HEIGHT 480
#define DEFAULT_WIN_LEFT 0
#define DEFAULT_WIN_TOP 0
...
#else
#define fimc_dbg(fmt, ...)		do{	\
		if(ctrl->id == 0)dev_info(ctrl->dev,fmt, ##__VA_ARGS__); \
	}while ( 0 )
#define fimc_info2	fimc_dbg
#define fimc_info1	fimc_dbg
#define fimc_warn	fimc_dbg
#define fimc_err		fimc_dbg
#endif
...
extern int fimc_reset_cam_capture(struct fimc_control *ctrl);
