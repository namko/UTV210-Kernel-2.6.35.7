...
struct mfc_dec_exe_arg {
	...
	int out_predisplay_Yaddr;            /* [OUT] previous frame decoding Y area physical address */
	int out_predisplay_Caddr;            /* [OUT] previous frame decoding CbCr area physical address */
};
