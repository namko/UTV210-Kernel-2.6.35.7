...
/**
 *diog.zhao 110310
 *before open, should check parameter at first,
 *if not, memory access error will occur.
 */
	if (NULL ==  _adb_dev)
		return -ENXIO;
...
/**
 *diog.zhao 110310
 *before release, should check parameter at first,
 *if not, memory access error will occur.
 */
	if (NULL != _adb_dev)
...
/**
 *diog.zhao 110310
 *spin_unlock_irq should called before req_get.
 */
