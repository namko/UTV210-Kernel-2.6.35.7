...
EXPORT_SYMBOL(s3c_fimc0_cfg_gpio_suspend);
void s3c_fimc0_cfg_gpio_resume(struct platform_device *pdev)
{
	s3c_fimc0_cfg_gpio(pdev);
}
EXPORT_SYMBOL(s3c_fimc0_cfg_gpio_resume);
