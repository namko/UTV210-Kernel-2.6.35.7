...
static void __iomem 		*g_ts0_base;
...
EXPORT_SYMBOL(get_s3c_adc_convert);

unsigned int get_adc_resolution()
{
    return plat_data->resolution;
}
EXPORT_SYMBOL(get_adc_resolution);
